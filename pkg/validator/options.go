...
// whose status is blocking per ctrf.IsFailingStatus (StatusFailed or
// StatusOther — an inconclusive outcome fails closed). Default: false (all
// phases run regardless of earlier failures). Set true to restore the
