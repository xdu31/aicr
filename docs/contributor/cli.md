...
The `Generate README` node here is the **per-component** `bundle/<component>/README.md`. The **root** `bundle/README.md` is generated by the deployer (see [Deployer Framework](#deployer-framework-gitops-integration) below).
